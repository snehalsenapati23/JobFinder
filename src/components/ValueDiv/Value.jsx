...
import vale from "../../assets/valeintine.png"
    ...
    <div className='mb-[4rem] mt-[6rem]  '>
      ...
      <div className="grid gap-[10rem] grid-cols-3 items-center ">
        ...
        <div className="singleGrid rounded-[10px] hover:bg-[#eeedf7] p-[1.5rem] " >
          ...
          <div className="flex items-center gap-3 " >
            <div className="imgDiv p-[4px] rounded-[.8rem] bg-inherit-[#dedef8] h-[40px] w-[40px] flex items-center justify-center ">
              <img src={vale} alt="" className='w-[70%] ' />
            </div>
            <span className='font-semibold text-textColor text-[18px]  '>
              Simplicity
        ...
        <div className="singleGrid rounded-[10px] hover:bg-[#eeedf7] p-[1.5rem] " >
          ...
          <p className='text-[25px]  text-textColor opacity-[.7] py-[1rem] font-semibold '>
            We work on the basis of creating trust which can be nurtured through aunthenticity and transparency
          </p>
        </div>
      </div>
<div className="card mt-[2rem] flex justify-between bg-blueColor p-[5rem] rounded-[10px] ">
 ...
 <button className='border-[2px] wi rounded-[30px]  px-[55px] text-[18px] font-semibold text-blueColor hover:bg-white border-blueColor '>Get Started
 </button>
</div>
